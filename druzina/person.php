<li class="table-element">
    <h2 class="element-heading"><?php echo $name ?></h2>
    <figure class="figure">
        ...
        <img src="<?php echo $img ?>" alt="<?php echo $alt ?>" class="figure-img <?php echo $pos ?>">
        <div class="figure-back <?php echo $color ?>"></div>
        <p class="figure-text"><?php echo $info ?></p>
    </figure>
</li>